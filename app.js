...
function sumArray(testArray){ //eslint-disable-line
  ...
  function sumArray(testArray){ //eslint-disable-line
    var myArray = 0;
    var myMsg = testArray.toString() + ' was passed in as an array of numbers, and ' + myArray + ' is their sum.';

    for (var i = 0; i < testArray.length; i++) {
      myArray = sum(testArray[i], myArray)[0];
      console.log(myArray);
    }
    return [myArray, myMsg];
  }
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  for (var i = 0; i < testArray.length; i++){
    ...
    console.log(myArray);
    var myMsg = testArray.toString() + ' have the product of ' + myArray + '.';
